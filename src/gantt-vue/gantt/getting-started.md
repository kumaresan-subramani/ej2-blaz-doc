...
You can display and assign the resource for each task in the Gantt component. Create a collection of object, which contains ID and name of the resource and assign it to the [`resources`](../api/gantt/#resources) property. Map the resource ID and name to [`resourceIDMapping`](../api/gantt/#resourceidmapping) and [`resourceNameMapping`](../api/gantt/#resourcenamemapping) properties, respectively.
